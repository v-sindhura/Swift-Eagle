      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="pin" name="pincode" placeholder="Pincode">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="Enter Card Holder's Name">
            ...
            <div class="row">
              <div class="col-50">
                ...
                <input type="text" id="expyear" name="expyear" placeholder="Enter Expiration Year">
              </div>
              <div class="col-50">
