...
<html>
    <head>
        <style>
            body{
            background: url(https://images4.alphacoders.com/912/thumb-1920-91296.jpg);
    ...
    <h1 class="headings">Swift Eagle</h1>
        ...
        <p>Username</p>
            ...
            <input type="submit" name="regis" value="Log In"><br>
            <a href="signincustomer.php">Don't have an account?</a><br>
        </form>
